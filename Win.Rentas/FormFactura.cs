...
namespace Win.Rentas
{
    public partial class FormFactura : Form
    {
        ...
        public FormFactura()
        {
            ...
            listaFacturasBindingSource.DataSource = _facturaBL.ObtenerFactura();
        ...
        private void DeshabilitarHabilitarBotones(bool valor)
        {
            ...
            bindingNavigatorAnularItem.Enabled = valor;
        ...
        private void bindingNavigatorAnularItem_Click(object sender, EventArgs e)
        {
            if (idTextBox.Text != "")
            {
                var resultado = MessageBox.Show("¿Desea anular ésta Factura", "Anular", MessageBoxButtons.YesNo);
